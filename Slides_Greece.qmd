...
m2 %>% addProviderTiles(provider = providers$Esri.WorldImagery) %>%
  ...
  addMarkers(lng = 22.486526, lat = 36.401496,
             icon = list(iconUrl = 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Map_marker.svg/1334px-Map_marker.svg.png',iconSize = c(25, 37)
   ))%>% 
  addMarkers(lng = 22.487487, lat = 36.402043,
             icon = list(iconUrl = 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Map_marker.svg/1334px-Map_marker.svg.png',iconSize = c(25, 37)
   ))%>% 
  addMarkers(lng = 22.485211, lat = 36.400278,
             icon = list(iconUrl = 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Map_marker.svg/1334px-Map_marker.svg.png',iconSize = c(25, 37)
   ))%>% 
  addMarkers(lng = 22.483744, lat = 36.400080,
             icon = list(iconUrl = 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Map_marker.svg/1334px-Map_marker.svg.png',iconSize = c(25, 37)
   ))
```
:::
...
leaflet() %>%   
  ...
  addProviderTiles(providers$OpenStreetMap,
                     ...
                     layerId = "DSMid") %>% 
  setView(lng =22.486526, lat = 36.401496, zoom = 15) %>%
...
m2 %>% addProviderTiles(provider = providers$Esri.WorldImagery) %>%
  ...
  addMarkers(lng = 22.536944, lat = 36.655599,
             icon = list(iconUrl = 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Map_marker.svg/1334px-Map_marker.svg.png',iconSize = c(25, 37)
   ))
```
:::
